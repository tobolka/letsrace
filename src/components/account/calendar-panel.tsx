  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="font-sans tracking-tight text-2xl font-semibold text-stone-900">My calendar</h1>
          <p className="text-sm text-stone-500">Who is going, registered, and paid.</p>
        </div>
        <Link href={`/${locale}`}>
      ...
      <section className="space-y-3">
        ...
        {rows.length === 0 ? (
          <p className="text-sm text-stone-500">No races marked yet — open a race and tap Going.</p>
        ) : (
