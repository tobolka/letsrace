...
const GAZETTEER: Record<string, { lat: number; lng: number; cc: string }> = {
  ...
  donovaly: { lat: 48.877, lng: 19.227, cc: "SK" },
  bojnice: { lat: 48.78, lng: 18.588, cc: "SK" },
  ...
  "rajecke teplice": { lat: 49.13, lng: 18.68, cc: "SK" },
  "rajecké teplice": { lat: 49.13, lng: 18.68, cc: "SK" },
  "klastor pod znievom": { lat: 48.97, lng: 18.77, cc: "SK" },
  "kláštor pod znievom": { lat: 48.97, lng: 18.77, cc: "SK" },
  "sarisske bohdanovce": { lat: 48.86, lng: 21.25, cc: "SK" },
  "šarišské bohdanovce": { lat: 48.86, lng: 21.25, cc: "SK" },
  ...
  konigswiesen: { lat: 48.41, lng: 14.84, cc: "AT" },
  "königswiesen": { lat: 48.41, lng: 14.84, cc: "AT" },
  ...
  prostejov: { lat: 49.472, lng: 17.111, cc: "CZ" },
  "prostějov": { lat: 49.472, lng: 17.111, cc: "CZ" },
  ...
  "ceska kamenice": { lat: 50.8, lng: 14.42, cc: "CZ" },
  "česká kamenice": { lat: 50.8, lng: 14.42, cc: "CZ" },
  "orlicke hory": { lat: 50.3, lng: 16.35, cc: "CZ" },
  ...
  "bratislava raca": { lat: 48.22, lng: 17.154, cc: "SK" },
  raca: { lat: 48.22, lng: 17.154, cc: "SK" },
  "rača": { lat: 48.22, lng: 17.154, cc: "SK" },
  ...
  budapest: { lat: 47.498, lng: 19.04, cc: "HU" },
