...
export const series = pgTable("series", {
  ...
  seriesType: text("series_type").notNull().default("other"),
  level: text("level").notNull().default("local"),
  competitionType: text("competition_type").notNull().default("other"),
  season: text("season"),
...
export const events = pgTable("events", {
  ...
  ageCategories: text("age_categories").array().notNull().default([]),
  level: text("level").notNull().default("local"),
  eventType: text("event_type").notNull().default("race"),
  competitionType: text("competition_type").notNull().default("other"),
  season: text("season"),
  uciClass: text("uci_class"),
